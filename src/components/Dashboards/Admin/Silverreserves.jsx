  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300 py-8 px-2">
        <div className="w-full max-w-lg bg-white/90 rounded-2xl shadow-xl p-8 border border-gray-300">
          ...
          <div className="flex gap-4 justify-center">
            <button
              ...
              className="px-6 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg font-semibold shadow"
            >
              Approve
            </button>
            <button
              onClick={() => { setAddAmount(''); setPendingAdd(0); }}
              className="px-6 py-2 bg-gray-400 hover:bg-gray-500 text-white rounded-lg font-semibold shadow"
            >
              Deny
            </button>
          </div>
        ...
        {toast.show && (
          <div className={`fixed top-6 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-xl shadow-lg z-[9999] flex items-center gap-2 text-white ${toast.type === 'success' ? 'bg-gray-700' : 'bg-red-600'}`}>
